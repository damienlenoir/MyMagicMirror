...
/*  MODULE CRYPTOS */
function displayBtc(res) {
    let btcCurrentPrice = Math.round(res.rate)
    htmlSet('BTC', 'BTC: ' + btcCurrentPrice + '€')
    ethPrice();
}
...
function displayEth(res) {
    let ethCurrentPrice = Math.round(res.rate)
    htmlSet('ETH', 'ETH: ' + ethCurrentPrice + '€')
}
